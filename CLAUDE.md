...
- **안티봇**: SSENSE·Farfetch·Nike 계열은 Akamai/PerimeterX. 초기 범위에서 제외한다.
  코치·마이클코어스·케이트스페이드·랄프로렌·뉴발란스·라코스테·레포메이션·올세인츠 등도
  2026-09-03 실제 스캔에서 403/404/410/503으로 확인되어 `targets.json`에 `blocked` 처리했다
  (Shopify가 아니라서가 아니라 서버사이드 요청 자체가 막히는 것으로 추정).
